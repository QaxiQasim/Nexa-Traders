  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#070908] text-foreground p-6 font-sans">
      <div className="max-w-lg w-full text-center rounded-3xl border border-rose-500/30 bg-[#0f1412] p-8 shadow-2xl backdrop-blur-2xl">
        <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-400 font-sans font-bold text-xl mb-4 border border-rose-500/30">
          ⚠️
        </div>
        ...
        <div className="mt-4 overflow-x-auto rounded-xl border border-rose-500/20 bg-rose-950/20 p-3 text-left font-sans text-[11px] text-rose-300 max-h-40">
          {error.message || String(error)}
        </div>

        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3 font-sans text-xs">
          <button
            type="button"
            onClick={resetError}
