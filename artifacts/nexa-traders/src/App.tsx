...
function SectionHeading({ eyebrow, title, copy, align = 'left' }: { eyebrow?: string; title: string; copy?: string; align?: 'left' | 'center' }) {
  return (
    <div className={`max-w-2xl ${align === 'center' ? 'mx-auto text-center' : ''}`}>
      {eyebrow && <div className={`mb-3.5 flex items-center gap-2.5 font-sans text-xs font-semibold uppercase tracking-[0.15em] text-primary ${align === 'center' ? 'justify-center' : ''}`}><span className="h-px w-6 bg-primary/70" />{eyebrow}</div>}
              ...
              <div className="group rounded-2xl border border-border/70 bg-card/40 p-4.5 transition-all hover:border-primary/50 hover:bg-card/80">
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    {copiedEmail === 'support@nexatraders.com' ? 'Copied' : 'Copy'}
                  </button>
                </div>
              </div>
              ...
              <div className="group rounded-2xl border border-border/70 bg-card/40 p-4.5 transition-all hover:border-primary/50 hover:bg-card/80">
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    {copiedEmail === 'compliance@nexatraders.com' ? 'Copied' : 'Copy'}
                  </button>
                </div>
              </div>
